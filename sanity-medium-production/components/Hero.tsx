...
function Hero() {
  return (
    <div className="flex border-b-2 px-4 border-t-2  border-solid border-black lg:px-[8em] justify-between  bg-yellow-400 h-[60vh]">
        <div className="flex flex-col gap-6 justify-center">
            <p className=" font-serif text-[4em] lg:text-[8em] text-black">Stay Curios.</p>
